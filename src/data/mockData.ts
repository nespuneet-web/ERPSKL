...
export const INITIAL_SUBJECTS: SubjectConfig[] = [
  { id: 'sub-1', code: 'MATH-101', name: 'Mathematics', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-2', code: 'SCI-102', name: 'Science & Technology', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 20, hasInternal: true, internalMaxMarks: 10, isGradeBasedOnly: false },
  { id: 'sub-3', code: 'ENG-103', name: 'English Language & Literature', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-4', code: 'HIN-104', name: 'Hindi Course A/B', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-5', code: 'SAN-105', name: 'Sanskrit Language', type: 'Language', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-6', code: 'SST-106', name: 'Social Science (History, Civics, Geo)', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-7', code: 'PHY-107', name: 'Physics (Senior)', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 30, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-8', code: 'CHEM-108', name: 'Chemistry (Senior)', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 30, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-9', code: 'BIO-109', name: 'Biology (Senior)', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 30, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-10', code: 'CS-110', name: 'Computer Science & Python', type: 'Vocational', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 30, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-11', code: 'IT-111', name: 'Information Technology & AI', type: 'Vocational', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 50, hasPractical: true, practicalMaxMarks: 50, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-12', code: 'ACC-112', name: 'Accountancy', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-13', code: 'BST-113', name: 'Business Studies', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-14', code: 'ECO-114', name: 'Economics', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-15', code: 'HIST-115', name: 'History', type: 'Optional', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-16', code: 'POL-116', name: 'Political Science', type: 'Optional', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-17', code: 'PE-117', name: 'Physical Education & Yoga', type: 'Vocational', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 70, hasPractical: true, practicalMaxMarks: 30, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-18', code: 'EVS-118', name: 'Environmental Studies (EVS)', type: 'Core', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 80, hasPractical: false, practicalMaxMarks: 0, hasInternal: true, internalMaxMarks: 20, isGradeBasedOnly: false },
  { id: 'sub-19', code: 'ART-119', name: 'Fine Arts & Painting', type: 'Vocational', maxMarks: 100, passingMarks: 33, hasTheory: true, theoryMaxMarks: 30, hasPractical: true, practicalMaxMarks: 70, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false },
  { id: 'sub-20', code: 'GK-120', name: 'General Knowledge & Reasoning', type: 'Additional', maxMarks: 50, passingMarks: 17, hasTheory: true, theoryMaxMarks: 50, hasPractical: false, practicalMaxMarks: 0, hasInternal: false, internalMaxMarks: 0, isGradeBasedOnly: false }
];
...
export const INITIAL_APPLICATIONS: AdmissionApplication[] = [
  {
    ...
    offerLetterSavedAt: '2026-04-11 11:30 AM'
  },
  {
    id: 'app-2',
    ...
    feePaid: true,
    registrationFee: 1500,
    documentsUploaded: ['Birth Certificate', 'Aadhaar']
  },
  {
    id: 'app-3',
  ...
  },
  {
    ...
    parentOccupation: 'Civil / Mechanical / Electrical Engineer',
    motherOccupation: 'Doctor / Surgeon / Medical Specialist',
  ...
  },
  {
    ...
    parentOccupation: 'Civil Services / IAS / IPS / Govt Officer',
    motherOccupation: 'Teacher / Professor / Educator',
  ...
  {
    id: 'app-6',
    applicationNo: 'APP-2026-106',
    studentName: 'Rohan Deshmukh',
    applyingClass: 'Class 1',
    gender: 'Male',
    dob: '2019-02-18',
    parentName: 'Vijay Deshmukh',
    parentOccupation: 'Architect / Interior Designer',
    motherOccupation: 'Media / Journalist / Content Specialist',
  ...
  {
    id: 'app-7',
    applicationNo: 'APP-2026-107',
    studentName: 'Ananya Roy',
    applyingClass: 'Nursery',
    gender: 'Female',
    dob: '2022-07-09',
    parentName: 'Subhash Roy',
    parentOccupation: 'Banking / Financial Services Executive',
    motherOccupation: 'Teacher / Professor / Educator',
    ...
    feePaid: true,
    registrationFee: 1500,
    documentsUploaded: ['Birth Certificate']
  },
  {
    id: 'app-8',
    applicationNo: 'APP-2026-108',
    ...
    parentOccupation: 'Software Engineer / IT Professional',
    motherOccupation: 'Business Owner / Entrepreneur',
    contactNumber: '+91 98555 66778',
    email: 'mehta.kabir@example.com',
    previousSchool: 'Kids World Playschool',
  ...
  {
    id: 'app-9',
    applicationNo: 'APP-2026-109',
    studentName: 'Pari Nambiar',
    applyingClass: 'Class 9',
    gender: 'Female',
    dob: '2011-11-05',
    parentName: 'Capt. R. Nambiar',
    parentOccupation: 'Defense / Police / Armed Forces',
    motherOccupation: 'Doctor / Surgeon / Medical Specialist',
    contactNumber: '+91 98666 77889',
    email: 'nambiar.pari@example.com',
    ...
    feePaid: true,
    registrationFee: 1500,
    documentsUploaded: ['Previous Grade Card', 'Aadhaar']
  }
];
